...
WIth the introduction of the Web AUdio API we can now play the original QBASIC play strings and they have been introduced in the source and the audio files has been removed.
